...
public class Rack2D extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("2D Rack");
        primaryStage.setScene(scene);
        primaryStage.show();
    }

    public static void addBackground(Group root) {
        // Load the background image
        Image backgroundImage = new Image(Rack2D.class.getResourceAsStream("/resources/bg10.jpg"));
    ...
    public static Group createRackView() {
        ...
        post1.setX(WIDTH / 2.0 - 60); // Center - Offse
